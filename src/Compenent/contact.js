...
const  Contact = () => {
    ...
    const senddata =async (e) =>
    {
        ...
        const res =  await fetch('https://e-commerce-contact-383bc-default-rtdb.firebaseio.com/Message.json',options)
        console.log(res)
        if(res)
        {
    ...
    return (
        ...
        <div className="contact_container">
            <div className="contant">
                ...
                <div className="form">
                    <form method="POST">
                        <input type="text" name="Name" value={users.Name} placeholder="Enter Your Full Name" autoComplete="off" onChange={data} ></input>
